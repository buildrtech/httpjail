...
#   ./scripts/build-and-upload-s3.sh --bucket buildr-bizops-httpjail-binaries --key httpjail/httpjail-linux-aarch64
#   ./scripts/build-and-upload-s3.sh --native-build

DEFAULT_PROFILE="buildr-bizops-prod"
DEFAULT_REGION="us-east-1"
DEFAULT_BUCKET="buildr-bizops-httpjail-binaries"
